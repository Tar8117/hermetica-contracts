...
(define-constant zest-interface-v1 .zest-interface)
...
(define-public (zest-open
  ...
  (begin
    ...
    ;; The borrowed asset will be transferred to Reserve by zest-interface-v1
    (try! (contract-call? .zest-interface-v1 zest-borrow
    ...
    ;; The hermetica-interface-v1 will move USDh from Reserve and return sUSDh to Reserve
    (try! (contract-call? .hermetica-interface-v1 hermetica-stake usdh-borrow-amount staking-trait))
...
(define-public (zest-open-add
  ...
  (begin
    ...
    (try! (contract-call? .zest-interface-v1 zest-supply
...
(define-public (zest-close
  ...
  (begin
    ...
    (let (
      ...
      (usdh-amount (try! (contract-call? .hermetica-interface-v1 hermetica-unstake-and-withdraw susdh-unstake-amount staking-trait staking-silo-trait))))
      ;; Repay USDh loan to Zest
      ;; The zest-interface-v1 will move borrowed asset from Reserve to Zest
      (try! (contract-call? .zest-interface-v1 zest-repay borrow-helper-trait borrowed-asset-trait usdh-repay-amount zest-interface))
...
;; @param - price-feed-1: Optional price feed update for oracle
;; @param - price-feed-2: Optional second price feed update
(define-public (zest-withdraw-fund-v1
  ...
  (begin
    ...
    (try! (contract-call? .zest-interface-v1 zest-withdraw
