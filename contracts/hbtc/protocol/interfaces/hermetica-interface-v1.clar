...
(define-public (hermetica-stake
  ...
  (let (
    ...
    (try! (contract-call? .susdh-token transfer susdh-amount this-contract reserve none))
...
(define-public (hermetica-unstake
  ...
  (staking <staking-trait>))
  (let (
    (transfer-result (try! (contract-call? .reserve transfer susdh-token amount this-contract)))
...
(define-public (hermetica-withdraw
  ...
  (let (
    ...
    (try! (contract-call? .usdh-token transfer amount this-contract reserve none))
...
(define-public (hermetica-unstake-and-withdraw
  ...
  (let (
    ...
    (try! (contract-call? staking-silo withdraw claim-id))
    (try! (contract-call? .usdh-token transfer usdh-amount this-contract reserve none))
...
(define-public (hermetica-mint
  ...
  (let (
    (minting-asset-data (contract-call? .state get-asset (contract-of minting-asset)))
    ...
    (try! (contract-call? .hq-hbtc check-is-trader contract-caller))
    (try! (contract-call? .state check-trading-auth (contract-of minting-auto) none (some (contract-of minting-asset)) none))
    (try! (contract-call? .reserve transfer minting-asset amount-asset this-contract))
    ...
    (let (
      ...
      (try! (contract-call? .usdh-token transfer amount-usdh this-contract reserve none))
...
(define-public (hermetica-redeem
  ...
  (let (
    (redeeming-asset-data (contract-call? .state get-asset (contract-of redeeming-asset)))
    ...
    (try! (contract-call? .hq-hbtc check-is-trader contract-caller))
    (try! (contract-call? .state check-trading-auth (contract-of minting-auto) none (some (contract-of redeeming-asset)) none))    
    (try! (contract-call? .reserve transfer usdh-token amount-usdh this-contract))
