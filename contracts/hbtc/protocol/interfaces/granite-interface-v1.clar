...
(define-public (granite-borrow
  ...
  (begin
    ...
    (try! (contract-call? .state-v1 check-trading-auth (contract-of borrower-trait) none (some (contract-of asset-trait)) none))
...
(define-public (granite-add-collateral
  ...
  (begin
    (try! (contract-call? .hq-hbtc-v1 check-is-trader contract-caller))
    (try! (contract-call? .state-v1 check-trading-auth (contract-of borrower-trait) none (some (contract-of collateral-trait)) none))
    (try! (contract-call? .reserve-v1 transfer collateral-trait amount this-contract))
